...
public static partial class Constants {
  ...
  private static class PatternText {

    public const string FSharpCustomOperator = "^(?:Amp|At|Bang|Bar|Comma|Divide|Dollar|Dot|Equals|Greater|Hat|LBrack" +
                                               "|LParen|Less|Minus|Multiply|Percent|Plus|Qmark|RBrack|RParen|Twiddle)+$";
